...
const SingleProduct = () => {
    ...
    return (
        <div>
            <FeaturedCategory Features = 'Category' />
            <FeaturedCategory Features = 'Product' />
                                ...
                                <div className='flex flex-col justify-center w-[640px] '>
                                    ...
                                    <form className="text-[20px]/[30px] font-medium flex flex-col">
                                        ...
                                        <div className='mb-[40px] flex items-start'>
                                            ...
                                            <label className='w-[612px] pl-[12px]' htmlFor="checkbox">Save my name, email, and website in this browser for the next time I comment.</label>
                                        </div>
