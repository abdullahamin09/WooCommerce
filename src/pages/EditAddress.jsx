    ...
    return (
        <form className='editAddress flex flex-col gap-[29px] mb-[88px]'>
            ...
            <div className="flex flex-col">
                ...
                <input className="h-[56px] text-[20px]/[30px] px-[2px] border-[2px] border-black focus:outline-none" type="text" name="companyName" id="" />
            </div>
            <div className="flex flex-col gap-[24px]">
                ...
                <div className="flex flex-col">
                    ...
                    <input className="h-[56px] text-[20px]/[30px] px-[2px] border-[2px] border-black focus:outline-none" type="number" name="postcode" id="" />
                </div>
            </div>
            <div className="flex flex-col">
                <label className="text-[20px]/[30px] font-medium mb-[20px]" htmlFor="email">Phone <span className="text-[#FF0000]">*</span></label>
                <input className="h-[56px] text-[20px]/[30px] px-[2px] border-[2px] border-black focus:outline-none" type="number" name="phone" id="" />
            </div>
            <div className="flex flex-col">
