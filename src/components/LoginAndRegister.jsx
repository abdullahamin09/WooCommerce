    ...
    return (
        <div className="login-register">
            <div className='flex'>
                <div className="login w-[540px] mx-auto my-20 flex flex-col gap-8 px-[30px] py-[20px] border-[2px] borer-black">
                    ...
                    <form action="" className="login-form gap-[20px] flex flex-col">
                        ...
                        <div className="button-wrap grid grid-cols-2 ">
                            ...
                            <div className='font-bold text-sky-500 mt-[10px]'>
            ...
            <div className='flex flex-col items-center justify-center gap-4 mb-20'>
                ...
                <div className="login-with grid grid-cols-3 gap-4">
                    <div className="facebook flex items-center bg-[#3B5998] w-[200px]">
                        <div className="img bg-white w-[42px] h-[45px] border-[1px] border-[#3B5998] flex items-center justify-center">
                    ...
                    <div className="facebook flex items-center bg-[#418AD0] w-[200px]">
                        <div className="img bg-white w-[42px] h-[45px] border-[1px] border-[#418AD0] flex items-center justify-center">
                    ...
                    <div className="twitter flex items-center bg-[#55ACEE] w-[200px]">
                        <div className="img bg-white w-[42px] h-[45px] border-[1px] border-[#55ACEE] flex items-center justify-center">
