                ...
                <div className="detailsArea mt-[42px] xl:pl-[200px] lg:pl-[100px]">
                    ...
                    {activeSection === 'reviews' && (
                        <div className="review flex flex-col items-center" >
                            <div className="border-b-[1px] border-[#B4B7C1] mb-[30px] w-[350px] lg:w-[640px]">
                            ...
                            <div className="userReview flex justify-center gap-[20px] mb-[40px] border-b-[1px] border-[#B4B7C1] pb-[30px]">
                                ...
                                <div className="reviewText">
                                    <div className='text-[16px]/[24px] text-[#9B9B9B] font-medium flex justify-between items-center max-sm:flex-col gap-[20px] mb-[20px] md:gap-[10px] md:mb-[10px]'>
                            ...
                            <div className='flex flex-col justify-center w-[350px] lg:w-[640px] '>
